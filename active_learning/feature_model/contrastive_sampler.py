                    ...
                    for i, slice in enumerate(slice_list):
                        ...
                        if self.use_patient:
                            ...
                            while (random_slice_in_patient in current_data_group) or (random_slice_in_patient is None):
                                random_slice_in_patient = current_patient_flat_index + self.random_state.choice(np.arange(len(full_patient_slice_lst)))
                        ...
                        if self.use_path_group:
                            ...
                            while (random_slice_in_path_group in current_data_group) or (random_slice_in_path_group is None):
                                random_slice_in_path_group = current_path_group_flat_index + self.random_state.choice(np.arange(len(full_path_group_slice_lst)))
