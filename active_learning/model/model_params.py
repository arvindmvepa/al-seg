                    ...
                    "liger21":
                      {
                          "train_split": "train+",
                          "left_base_im_list": "train+",
                          "right_base_im_list": "liger_num_clusters21_hed.txt",
                          "orig_train_im_list_file": os.path.join("spml", "datasets", "voc12", "train+liger_num_clusters21_hed.txt"),
                          "left_base_pim_list": "panoptic_train+",
                          "right_base_pim_list": "hed.txt",
                          "orig_train_pim_list_file" : os.path.join("spml", "datasets", "voc12",  "panoptic_train+_hed.txt"),
                          "val_pim_list": os.path.join("spml", "datasets", "voc12", "panoptic_val.txt"),
                     ...
                     "liger21_dino":
                         {
                             "train_split": "train+",
                             "left_base_im_list": "train+",
                             "right_base_im_list": "liger_num_clusters21_dino_hed.txt",
                             "orig_train_im_list_file": os.path.join("spml", "datasets", "voc12",
                                                                     "train+liger_num_clusters21_dino_hed.txt"),
                             "left_base_pim_list": "panoptic_train+",
                             "right_base_pim_list": "hed.txt",
                             "orig_train_pim_list_file": os.path.join("spml", "datasets", "voc12",
                                                                      "panoptic_train+_hed.txt"),
                             "val_pim_list": os.path.join("spml", "datasets", "voc12", "panoptic_val.txt"),
                             "exec_script": "spml/bashscripts/voc12/train_spml_box_al.sh",
                             "train_results_dir": os.path.join("stage1", "results", "train+", "semantic_gray"),
                             "train_logits_path": os.path.join("stage1", "results", "train+", "logits",
                                                               "save_preds.npz")
                         },
                    "liger21_cb":
                      {
                          "train_split": "train+",
                          "left_base_im_list": "train+",
                          "right_base_im_list": "liger_num_clusters21_cb_hed.txt",
                          "orig_train_im_list_file": os.path.join("spml", "datasets", "voc12", "train+liger_num_clusters21_cb_hed.txt"),
                          "left_base_pim_list": "panoptic_train+",
                          "right_base_pim_list": "hed.txt",
                          "orig_train_pim_list_file" : os.path.join("spml", "datasets", "voc12",  "panoptic_train+_hed.txt"),
                          "val_pim_list": os.path.join("spml", "datasets", "voc12", "panoptic_val.txt"),
                     ...
                     "liger21_dino_cb":
                         {
                             "train_split": "train+",
                             "left_base_im_list": "train+",
                             "right_base_im_list": "liger_num_clusters21_dino_cb_hed.txt",
                             "orig_train_im_list_file": os.path.join("spml", "datasets", "voc12",
                                                                     "train+liger_num_clusters21_dino_cb_hed.txt"),
                             "left_base_pim_list": "panoptic_train+",
                             "right_base_pim_list": "hed.txt",
                             "orig_train_pim_list_file": os.path.join("spml", "datasets", "voc12",
                                                                      "panoptic_train+_hed.txt"),
                    ...
                    "liger21_mae_large":
                      {
                          "train_split": "train+",
                          "left_base_im_list": "train+",
                          "right_base_im_list": "liger_num_clusters21_mae_large_hed.txt",
                          "orig_train_im_list_file": os.path.join("spml", "datasets", "voc12", "train+liger_num_clusters21_mae_large_hed.txt"),
                          "left_base_pim_list": "panoptic_train+",
                          "right_base_pim_list": "hed.txt",
                          "orig_train_pim_list_file" : os.path.join("spml", "datasets", "voc12",  "panoptic_train+_hed.txt"),
                          "val_pim_list": os.path.join("spml", "datasets", "voc12", "panoptic_val.txt"),
