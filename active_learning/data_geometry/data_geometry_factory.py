...
from active_learning.data_geometry.contrastive_coreset import ContrastiveCoreset
...
class DataGeometryFactory:
    ...
    def create_data_geometry(data_geometry_type, **geometry_kwargs):
        ...
        elif data_geometry_type == "contrastive":
            geometry = ContrastiveCoreset(**geometry_kwargs)
        else:
