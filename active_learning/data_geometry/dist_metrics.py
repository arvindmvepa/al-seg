...
def metric_w_config(image_vec1, image_vec2, image_metric, max_dist, wt_max_dist_mult, num_im_features, num_label_features,
                    ...
                    slice_pos_starting_index=None, slice_pos_ending_index=None, path_group_starting_index=None,
                    path_group_ending_index=None, uncertainty_starting_index=None, uncertainty_ending_index=None,
                    normalize_pos_by_label_ct=False, pos_wt=1.0, extra_feature_wt=1.0, patient_wt=0.0, phase_wt=0.0,
