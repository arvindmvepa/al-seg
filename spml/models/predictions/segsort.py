...
class Segsort(nn.Module):
    ...
    def predictions(self, datas, targets={}, clip_similarity=None):
        ...
        if (semantic_memory_prototypes is not None
            ...
            for i in range(num_groups):
                ...
                if clip_similarity is not None:
                    _, top_k_semantic_labels = segsort_eval.top_k_ranking_with_clip(
    ...
    def forward(self, datas, targets=None,
                with_loss=True, with_prediction=False, clip_similarity=None):
        ...
        if with_prediction:
            ...
            semantic_pred, semantic_score = self.predictions(datas, targets, clip_similarity=clip_similarity)
