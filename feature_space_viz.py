...
if __name__ == "__main__":
    ...
    cl_model_path = "/home/amvepa91/al-seg1/DMPLS_exp4_coreset_xt0_pos_loss1_wt05_pos_loss2_wt05_use_phase_use_patient_v15/cl_feature_model.pt"
    save_path = os.path.basename(cl_model_path).replace(".pt", ".npy")
